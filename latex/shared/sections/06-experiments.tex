...
\begin{table}[t]
  ...
  \begin{tabular}{@{}p{27mm}p{66mm}p{39mm}@{}}
    \toprule
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}p{27mm}p{65mm}p{38mm}@{}}
    \toprule
...
inferred policies use stationary physical-state inputs.  Discrete SAC and
Double Q-learning therefore share the same time-aliasing limitation as the
